...
def manually_fill():
    ...
    def fill_attendance():
        ...
        try:
            global cursor
            connection = _mysql_connector(
                host='localhost', user='root', password='7780', db='AMS')
        ...
        if subb == '':
            ...
            def create_csv():
                ...
                csv_name = 'E:/Attendance management system/Attendance/'+DB_table_name+'.csv'
            ...
            def attf():
                import subprocess
                subprocess.Popen(
                    r'explorer /select,"E:\Attendance management system\Attendance\-------Check atttendance-------"')
    ...
    def Fillattendances():
        ...
        if time.time() < future:
            if sub == '':
                ...
                root.configure(background='grey80')
                cs = 'E:\Attendance management system\Subjects' + fileName
    ...
    def log_in():
        ...
        if username == 'Sandeep':
            if password == '7780':
                ...
                cs = 'E:\Attendance management system\StudentDetails\StudentDetails.csv'
                with open(cs, newline="") as file:
                    reader = csv.reader(file)
                    r = 0
